 ...
 */
export declare function commandAllowed(mode: ParseModePrivate, command: string): boolean;
export declare function getValue(mode: ParseModePrivate, symbol: string): string;
